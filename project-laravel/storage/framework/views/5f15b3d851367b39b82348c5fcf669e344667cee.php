...
<body>
    ...
    <header>
        <nav class="navbars">
            ...
            <ul class="navigation">
                <li> <a class="<?php echo e($title === 'Home' ? 'active' : ''); ?>" style="text-decoration: none"
                        href="/">home</a></li>
                <li> <a class="<?php echo e($title === 'Order' ? 'active' : ''); ?>" style="text-decoration: none"
                ...
                <li> <a class="<?php echo e($title === 'Services' ? 'active' : ''); ?>" style="text-decoration: none"
                        href="/service">service</a></li>
                <li> <a class="<?php echo e($title === 'Company' ||
                $title === 'News' ||
                $title === 'FAQ' ||
                $title === 'Event' ||
                $title === 'Top Employee' ||
    ...
    <div class="navbar_main">
        <div class="navbar_display" style="<?php echo e($title === 'Sign Up' ? 'display : block' : ''); ?>">
            <?php echo $__env->make('layouts.partials.navbarRegister', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        <div class="navbar_display" style="<?php echo e($title === 'Sign In' ? 'display : block' : ''); ?>">
            <?php echo $__env->make('layouts.partials.navbarLogin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        <div class="navbar_display" style="<?php echo e($title === 'Services' ? 'display : block' : ''); ?>">
            <?php echo $__env->make('layouts.partials.navbarService', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        <div class="navbar_display"
            style="<?php echo e($title === 'Company' ||
            $title === 'Dangerous Goods' ||
            $title === 'Event' ||
            $title === 'FAQ' ||
            $title === 'News' ||
            ...
            $title === 'Top Employee'
                ? 'display : block'
                : ''); ?>">
            <?php echo $__env->make('layouts.partials.navbarAbout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        <div class="navbar_display"
            style="<?php echo e($title === 'Trace' || $title === 'Rates' || $title === 'Location' ? 'display : block' : ''); ?>">
            <?php echo $__env->make('layouts.partials.navbarTrack', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php /**PATH C:\applications\project-laravel\resources\views/layouts/main.blade.php ENDPATH**/ ?>