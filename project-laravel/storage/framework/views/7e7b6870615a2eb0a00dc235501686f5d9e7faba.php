    ...
    <header>
        <nav class="navbars">
            ...
            <ul class="navigation">
                ...
                <li> <a class="<?php echo e(($title === "Trace"||$title === "Rates"||$title === "Location") ? 'active' : ''); ?>" href="/trace">track</a></li>
                <li> <a class="<?php echo e(($title === "Service") ? 'active' : ''); ?>" href="/service">service</a></li>
                <li> <a class="<?php echo e(($title === "Company"||$title === "News"||$title === "FAQ")  ? 'active' : ''); ?>" href="/company">about</a></li>
            </ul>
        </nav>
    ...
    <div class="chat-popup" id="myForm">
        ...
        <form action="/action_page.php" class="form-container">
            ...
            <div class="index_db_textbox_cont">
                ...
                <div class="index_db_textbox_item">
                    <a id="chart_with_us" href="javascript:;"
                        style="text-decoration: none; color: #000; color: #000">
                ...
                <div class="container text-center text-md-start mt-5">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                      ...
                      <p><i class="fas fa-home me-3"></i> Jl. Janti Gg. Arjuna No. 59, Karangjambe, Banguntapan, Bantul,
                        Yogyakarta 5519</p>
                      <p>
        ...
        <script src="bergerak.js"></script>

</body>

</html>
<?php /**PATH C:\applications\project-laravel\resources\views/layouts/mainTrack.blade.php ENDPATH**/ ?>